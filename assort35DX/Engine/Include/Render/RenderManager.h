...
private:
    ...
    Vector4 m_RenderTypeTint[RT2D_End];

public:
    void SetRenderTypeTint(Render_Type_2D RenderType, unsigned int r, unsigned int g, unsigned int b, unsigned int a);
    void SetRenderTypeTint(Render_Type_2D RenderType, Vector4 Color);
