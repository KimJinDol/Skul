...
{
    RT2D_None = -1,
    RT2D_Background,// z : 0.75f ~ 0.9999f
    RT2D_MAP,
    RT2D_Back,      // z : 0.5f ~ 0.74999f
    RT2D_Default,   // z : 0.25f ~ 0.49999f
    RT2D_Particle,  // z : 0.f ~ 0.249999f
    RT2D_End
};
