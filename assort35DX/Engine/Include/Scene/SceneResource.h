...
public:
    ...
    bool CreateMaterial(const std::string& Name, const std::string& TextureName, const TCHAR* FileName,
...
public:
    bool CreateAnimationSequence2D(const std::string& SequenceName, float PlayTime = 1.f,
        float PlayRate = 1.f);
    bool CreateAnimationSequence2D(const std::string& SequenceName, float PlayTime,
        const std::string& TextureName, unsigned int x, unsigned int y,
        unsigned int Count, const Vector2& FrameSize = Vector2(400.f, 300.f));
