...
bool CPlayer2D::Init()
{
	...
	CInput::GetInst()->AddKeyCallback<CPlayer2D>("MoveRight", KT_Push, this, &CPlayer2D::RotationZ);
	CInput::GetInst()->AddKeyCallback<CPlayer2D>("MoveLeft", KT_Push, this, &CPlayer2D::RotationZInv);
