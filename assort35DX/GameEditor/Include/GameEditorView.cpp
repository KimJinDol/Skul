...
BEGIN_MESSAGE_MAP(CGameEditorView, CView)
	...
	ON_COMMAND(ID_DETAILWINDOW, &CGameEditorView::OnDetailwindow)
	ON_COMMAND(ID_MAPEDITORWINDOW, &CGameEditorView::OnMapEditorwindow)
END_MESSAGE_MAP()
...
void CGameEditorView::OnInitialUpdate()
{
	...
	CEngine::GetInst()->SetMode(EngineMode::Editor);
...
void CGameEditorView::OnDetailwindow()
{
	CIMGUIWindow* Window = CIMGUIManager::GetInst()->FindIMGUIWindow("DetailWindow");

	Window->Open();
}

void CGameEditorView::OnMapEditorwindow()
{
	CIMGUIWindow* Window = CIMGUIManager::GetInst()->FindIMGUIWindow("TileMapWindow");
