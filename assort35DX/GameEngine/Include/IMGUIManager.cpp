...
bool CIMGUIManager::Init(HWND hWnd)
{
	...
	AddWindow<CSceneObjectWindow>("ObjectWindow");
	
	CObjectDetailWindow* DetailWindow = AddWindow<CObjectDetailWindow>("DetailWindow");
	/*DetailWindow = AddWindow<CSpriteDetailWindow>("SpriteDetailWindow");*/
	//m_vecDetailWindow.push_back(DetailWindow);

	// OnDetailWindow("ObjectWindow");
...
void CIMGUIManager::OnDetailWindow(const std::string& Name)
{
	//auto iter = m_vecDetailWindow.begin();
	//auto iterEnd = m_vecDetailWindow.end();
